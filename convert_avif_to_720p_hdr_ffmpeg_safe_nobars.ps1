...
$outputDir = Join-Path $sourceDir "AVIF_720p_AVIF_HDR_NoBars"
$magickCandidates = @(
...
Write-Host ""
Write-Host "Output format: AVIF HDR"
Write-Host "Resize mode: keep original ratio, no black bars"
Write-Host "Target: height up to 720, width auto"
Write-Host ""
...
foreach ($file in $files) {
    ...
    try {
        ...
        & $magickExe $magickInput -auto-orient -resize x720 $tempPng
