                ...
                <div className="relative" key={item.href}>
                  ...
                  {travelMenuOpen ? (
                    <div role="menu" className="absolute left-1/2 top-[calc(100%+14px)] w-64 -translate-x-1/2 overflow-hidden rounded-2xl border border-white/12 bg-ink/95 p-2 shadow-2xl backdrop-blur-2xl">
                      <Link role="menuitem" href="/travel/namibia/" className="block rounded-xl px-4 py-3 transition hover:bg-white/8" onClick={() => setTravelMenuOpen(false)}><small className="block text-[10px] tracking-[.18em] text-gold">AFRICA</small><b className="mt-1 block text-sm font-medium text-pearl">NAMIBIA · 納米比亞</b></Link>
                      <Link role="menuitem" href="/travel/canada/" className="block rounded-xl px-4 py-3 transition hover:bg-white/8" onClick={() => setTravelMenuOpen(false)}><small className="block text-[10px] tracking-[.18em] text-emerald-300">NORTH</small><b className="mt-1 block text-sm font-medium text-pearl">CANADA · 加拿大</b></Link>
                      <Link role="menuitem" href="/travel/italy/" className="block rounded-xl px-4 py-3 transition hover:bg-white/8" onClick={() => setTravelMenuOpen(false)}><small className="block text-[10px] tracking-[.18em] text-[#d36b4b]">EUROPE</small><b className="mt-1 block text-sm font-medium text-pearl">ITALIA · 義大利</b></Link>
