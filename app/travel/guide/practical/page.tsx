...
export default function PracticalPage() {
  ...
  <section className="photo-insert"><span>FIELD NOTE / FOOD</span><h2>野味可以試，<br />但先從一小份開始。</h2><p>餐廳的 Platter of the Day 適合多人分食，先淺嚐不同肉類與配菜，再決定自己是否習慣。</p><figure><img src="/travel/platter-of-the-day.avif" alt="納米比亞餐廳的 Platter of the Day"/><figcaption>野味多數人不一定習慣，淺嚐即可。</figcaption></figure></section>
