...
export default function PracticalPage() {
  return <main className="field-page">
    ...
    <section className="field-hero">
      ...
      <div><span>WEATHER · POWER · NETWORK · FOOD</span><span>NAMIBIA</span></div>
    </section>
    ...
    <section className="field-section">
      ...
      <div className="field-grid">
        <article><b>OUR TRIP</b><h3>實體 SIM，當時仍是最實際的選擇</h3><p>納米比亞主要電信商是 MTC。我們旅行時使用實體 SIM，也遇到手機本身不支援 eSIM 的問題。MTC 幾乎在這趟旅程同一時期，才正式向本地客戶推出 eSIM。</p></article>
    ...
    <section className="field-section field-light">
      ...
      <div className="field-grid">
        ...
        <article><b>BITE PREVENTION</b><h3>真正難找的，是適合人體的高濃度敵避</h3><p>台灣核准的有效成分包括 DEET（敵避／待乙妥）、picaridin（派卡瑞丁）與 IR3535（伊默克）。以行前採買的經驗來說，當時在台灣較容易找到的人體用 DEET 約為 12%；我們另外找到一款濃度更高、同樣確認可用於人體的產品，實際打電話詢問時，對方卻告知已經停產。這不是現行法規的濃度上限，而是我們當時實際遇到的供應狀況。</p><p>最後我們改從國外購買，並準備了滾珠與噴劑兩種形式。滾珠較容易控制塗抹位置，適合臉部周圍或較小範圍；噴劑則方便處理手腳等較大面積。無論是哪一種，都要先確認濃度、適用年齡，以及包裝是否明確標示可用於人體皮膚，使用臉部時也應先塗在手上再避開眼口，而不是直接朝臉噴灑。</p><p>市面上也混有只能用於環境的敵避產品，很容易看見成分名稱就買錯。如果找不到合適的 DEET，可向藥師或旅遊醫學門診詢問 picaridin 等核准替代選擇。黃昏到清晨仍要穿著淺色長袖、長褲與襪子，住宿時優先使用紗窗、空調或蚊帳；即使正在服用瘧疾預防藥，這些措施仍不能省略。</p></article>
      </div>
