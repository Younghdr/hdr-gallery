  ...
  return <main className="field-page">
    ...
    <section className="field-section field-light">
      ...
      <div className="medicine-block">
        ...
        <div className="child-note"><b>CHLOROQUINE / 為什麼表格沒有氯奎寧？</b><p>你記得的抗藥性藥物，應該就是 Chloroquine（氯奎寧）。納米比亞主要流行惡性瘧原蟲，官方資料標示當地存在氯奎寧抗藥性，因此不能自行把它當成通用預防藥。馬偕院方資料也將 Mefloquine 說明為可用於具有氯奎寧抗藥性的非洲等地；舊版價目表雖同時列有 Hydroxychloroquine，醫院備有某種藥物，並不等於它適合每個目的地。這不是人體對藥產生抗藥性，也不代表所有預防藥都失效；Atovaquone／Proguanil、Doxycycline 與 Mefloquine 仍是官方列出的可評估選項。選藥必須跟著目的地的抗藥性資料，而不是沿用上一次去其他國家剩下的藥。</p></div>
    ...
    <section className="field-picks">
      ...
      <div className="field-grid">
        ...
        <article><b>GAME TASTING GUIDE</b><h3>第一次吃野味，怎麼點？</h3><p>Windhoek 的 Joe’s Beerhouse 是最有代表性的入門地點之一。第一次最適合從一份 game platter（野味拼盤）開始：份量不用太大，卻能直接比較不同肉質。野味普遍脂肪少，做成排餐時過熟容易乾；熟度仍應依餐廳建議與個人飲食習慣決定。</p><ul className="game-guide"><li><strong>01 · 南非劍羚｜Oryx / Gemsbok</strong>長著筆直長角、適應乾旱環境的羚羊，主要分布在納米比亞、波札那與南非等南部非洲乾燥地區，也是納米比亞國徽上的國獸。肉色深、脂肪少，適合做成牛排，是最推薦先試的一款。</li><li><strong>02 · 跳羚｜Springbok</strong>風味相對細緻，適合菲力、小份排餐，或放在拼盤裡比較。</li><li><strong>03 · 大捻角羚｜Kudu</strong>味道比一般牛肉更深，排餐與慢燉都常見；想感受明顯野味，可以從它開始。</li><li><strong>04 · 鴕鳥｜Ostrich</strong>雖然是禽類，肉色與口感更接近瘦紅肉，通常也是接受度較高的選擇。</li><li><strong>05 · 鱷魚、斑馬｜Crocodile / Zebra</strong>適合放在綜合拼盤裡嘗鮮，不一定需要各點一份主餐；最後的味道仍很看部位與料理方式。</li></ul><p>我們造訪 Joe’s 時生意非常好，上菜需要等上一段時間；適合事先訂位，也不要把晚餐塞在很趕的行程裡。後來餐廳經營團隊已有變動，今天的菜單、品質與速度未必和我們當時完全相同。</p></article>
