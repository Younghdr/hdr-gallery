...
export default function MoneyShoppingPage(){return <main className="field-page money-shopping-page">
  ...
  <section className="field-section field-light"><span>02 / WHERE TO BUY</span><header><div></div><h2><i>市集可以慢慢談，</i><i>店家與機場也值得逛。</i></h2></header><div className="field-copy"><p>Swakopmund 的公園與路邊市集，是旅途中很有意思的一站。可以一邊看手藝、一邊和攤主聊天，也可以禮貌議價；如果一次挑了幾件，比起直接把價格砍半，我們更習慣問一句：「一起買，可以算多少？」</p><figure className="city-wildlife-note"><img src="/travel/lion-window.avif" alt="城市櫥窗裡的沙漠獅雕像"/><figcaption>城市的櫥窗裡，也會突然遇見納米比亞的荒野。</figcaption></figure><p>但不喜歡殺價，也完全不必勉強自己。以我們這次的經驗來說，Windhoek 與 Swakopmund 有店面的商家，以及機場，其實都沒有特別貴。店內商品陳列清楚，品質與價格更容易比較；機場也能找到價格合理的寶石原礦與伴手禮，不需要為了害怕買貴，沿途急著把東西買齊。</p><p>市集適合享受挑選與交流，店家和機場則買得輕鬆。沒有哪一種方式一定比較好，選擇自己自在的購物方式就可以。購買寶石或動物來源工藝品時，仍應確認來源、攜帶限制並保留收據。</p></div></section>
