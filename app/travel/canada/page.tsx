    ...
    <main className="canada-page">
      ...
      <section className="canada-hero" style={{ backgroundImage: `url('${BASE_PATH}/travel/canada/hero.png')` }}>
        ...
        <div className="canada-hero-copy">
          <p>13 DAYS · FROM 62°27′N TO THE ROCKIES · OCT</p>
          <h1>CANADA</h1>
          <h2>向北，直到天空發光</h2>
      ...
      <article className="canada-journal" id="first-night">
        ...
        <figure className="canada-photo"><img src={`${BASE_PATH}/travel/canada/first-trace.avif`} alt="黃刀鎮極光村漆黑的場地上，第一道淡綠色極光出現在樹梢旁" /><figcaption><b>THE FIRST TRACE · AURORA VILLAGE</b><span>YELLOWKNIFE · 04 OCT</span></figcaption></figure>
